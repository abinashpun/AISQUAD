...
DeepFace.stream(db_path='test_ground/test_photos',model_name ='VGG-Face', detector_backend = 'ssd', distance_metric = 'cosine', enable_face_analysis = False, source = 0, time_threshold = 5, frame_threshold = 5 )
